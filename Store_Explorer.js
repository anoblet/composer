...
define("dojox/data/Store_Explorer", ["dijit","dojo","dojox","dojo/require!dojox/grid/DataGrid,dojox/data/ItemExplorer,dijit/layout/BorderContainer,dijit/layout/ContentPane"], function(dijit,dojo,dojox){
dojo.provide("dojox.data.Store_Explorer");
dojo.require("dojox.grid.DataGrid");
dojo.require("dojox.data.ItemExplorer");
dojo.require("dijit.layout.BorderContainer");
dojo.require("dijit.layout.ContentPane");

dojo.declare("dojox.data.Store_Explorer", dijit.layout.BorderContainer, {
	...
	postCreate: function(){
		...
		*/
		...
		var leadingCP = new dijit.layout.ContentPane({
			region: 'leading',
		}).placeAt(this);

		var Tree = this.tree = new Item_Explorer({
			store: this.store,
			_container: this,
			"style": "width: auto",
			openOnClick: true
			});
		Tree.set({"_container": this});
		leadingCP.attr("content", Tree);
